...
describe(ContractName.Forwarder, () => {
    ...
    before(async () => {
        ...
        const zrxemit DepositAmount = Web3Wrapper.toBaseUnitAmount(new BigNumber(10000), 18);
        await web3Wrapper.awaitTransactionSuccessAsync(
            await zrxToken.transfer.sendTransactionAsync(forwarderContract.address, zrxemit DepositAmount),
        );
