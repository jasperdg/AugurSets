...
describe('MixinSignatureValidator', () => {
    ...
    describe('setSignatureValidatorApproval', () => {
        it('should  a SignatureValidatorApprovalSet with correct args when a validator is approved', async () => {
            const approval = true;
        ...
        it('should  a SignatureValidatorApprovalSet with correct args when a validator is disapproved', async () => {
